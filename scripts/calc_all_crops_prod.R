...
processed_crops <- sapply(str_split(basename(list.files(path = "data/crop_per_kg_climate/", pattern = "_production.csv", recursive = TRUE, full.names = FALSE)), pattern = "_"), "[[", 1)
